...
export default function Sidebar() {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="w-full h-[4rem] flex items-center p-2 border-b border-transparent">
        <div className="w-full flex items-center gap-2 px-3 py-1.5 min-w-0 hover:bg-[#F5F5F5] transition-colors rounded-xl cursor-pointer">
          {/* Avatar */}
